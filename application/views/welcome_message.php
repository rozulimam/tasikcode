...
<head>
	...
	<!-- Bootstrap CSS -->
	<link rel="stylesheet" href="cdn.scaleupid/stack/assets/css/bootstrap.min.css">
	<!-- Icon -->
	<link rel="stylesheet" href="cdn.scaleupid/stack/assets/fonts/line-icons.css">
	<!-- Slicknav -->
	<link rel="stylesheet" href="cdn.scaleupid/stack/assets/css/slicknav.css">
	<!-- Owl carousel -->
	<link rel="stylesheet" href="cdn.scaleupid/stack/assets/css/owl.carousel.min.css">
	<link rel="stylesheet" href="cdn.scaleupid/stack/assets/css/owl.theme.css">

	<link rel="stylesheet" href="cdn.scaleupid/stack/assets/css/magnific-popup.css">
	<link rel="stylesheet" href="cdn.scaleupid/stack/assets/css/nivo-lightbox.css">
	<!-- Animate -->
	<link rel="stylesheet" href="cdn.scaleupid/stack/assets/css/animate.css">
	<!-- Main Style -->
	<link rel="stylesheet" href="cdn.scaleupid/stack/assets/css/main.css">
	<!-- Responsive Style -->
	<link rel="stylesheet" href="cdn.scaleupid/stack/assets/css/responsive.css">
...
<body>
	...
	<header id="header-wrap">
		...
		<nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
			<div class="container">
				...
				<a href="index.html" class="navbar-brand"><img src="cdn.scaleupid/stack/assets/img/logo.png" alt=""></a>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12">
						...
						<div class="img-thumb text-center wow fadeInUp" data-wow-delay="0.6s">
							<img class="img-fluid" src="cdn.scaleupid/stack/assets/img/hero-1.png" alt="">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12">
					...
					<h5>Please purchase full version of the template to get all features/pages and facilities</h5>
					<p></p>
			...
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-3">
					...
					<div class="team-item text-center wow fadeInRight" data-wow-delay="0.3s">
						<div class="team-img">
							<img class="img-fluid" src="cdn.scaleupid/stack/assets/img/team/team-01.png" alt="">
				...
				<div class="col-sm-6 col-md-6 col-lg-3">
					...
					<div class="team-item text-center wow fadeInRight" data-wow-delay="0.6s">
						<div class="team-img">
							<img class="img-fluid" src="cdn.scaleupid/stack/assets/img/team/team-02.png" alt="">
							<div class="team-overlay">
								<div class="overlay-social-icon text-center">
									<ul class="social-icons">
										<li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
				...
				<div class="col-sm-6 col-md-6 col-lg-3">
					...
					<div class="team-item text-center wow fadeInRight" data-wow-delay="0.9s">
						<div class="team-img">
							<img class="img-fluid" src="cdn.scaleupid/stack/assets/img/team/team-03.png" alt="">
							<div class="team-overlay">
								<div class="overlay-social-icon text-center">
									<ul class="social-icons">
										<li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
				...
				<div class="col-sm-6 col-md-6 col-lg-3">
					...
					<div class="team-item text-center wow fadeInRight" data-wow-delay="1.2s">
						<div class="team-img">
							<img class="img-fluid" src="cdn.scaleupid/stack/assets/img/team/team-04.png" alt="">
							<div class="team-overlay">
								<div class="overlay-social-icon text-center">
									<ul class="social-icons">
										<li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
	...
	<script src="cdn.scaleupid/stack/assets/js/jquery-min.js"></script>
	<script src="cdn.scaleupid/stack/assets/js/popper.min.js"></script>
	<script src="cdn.scaleupid/stack/assets/js/bootstrap.min.js"></script>
	<script src="cdn.scaleupid/stack/assets/js/owl.carousel.min.js"></script>
	<script src="cdn.scaleupid/stack/assets/js/wow.js"></script>
	<script src="cdn.scaleupid/stack/assets/js/jquery.nav.js"></script>
	<script src="cdn.scaleupid/stack/assets/js/scrolling-nav.js"></script>
	<script src="cdn.scaleupid/stack/assets/js/jquery.easing.min.js"></script>
	<script src="cdn.scaleupid/stack/assets/js/jquery.counterup.min.js"></script>
	<script src="cdn.scaleupid/stack/assets/js/waypoints.min.js"></script>
	<script src="cdn.scaleupid/stack/assets/js/jquery.slicknav.js"></script>
	<script src="cdn.scaleupid/stack/assets/js/main.js"></script>
